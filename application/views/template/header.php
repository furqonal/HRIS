...
<head>
	...
	<!--<script type="text/javascript" src="<?php echo base_url() ?>assets/js/pages/datatables_extension_scroller.js"></script>-->
					...
					<div class="sidebar-category sidebar-category-visible">
						...
						<?php
							...
							if ($row->id_jabatan == 1 || $row->id_jabatan == 2) { ?>
								...
								<li class="<?php echo $manajemencuti; ?>"><a href="<?php echo base_url() ?>c_atasan/persetujuanCuti"><i class="icon-list-unordered"></i> <span>Manajemen Cuti</span></a></li>

								<li class="<?php echo $manajemenperjalanandinas; ?>"><a href="<?php echo base_url() ?>c_atasan/persetujuanPerjalananDinas"><i class="icon-list-unordered"></i> <span>Manajemen Perjalanan Dinas</span></a></li>
								<li class="<?php echo $manajemenjobprofile; ?>"><a href="<?php echo base_url() ?>c_atasan/manajemenjobprofile"><i class="icon-list-unordered"></i> <span>Manajemen Job Profile</span></a></li>

								<li class="<?php echo $manajemenjobprofile; ?>"><a href="<?php echo base_url() ?>c_atasan/data_comapp"><i class="icon-list-unordered"></i> <span>Penilaian kompetensi</span></a></li>

								<li class="<?php echo $manajemenjobprofile; ?>"><a href="<?php echo base_url() ?>c_atasan/performa_atasan"><i class="icon-list-unordered"></i> <span>Penilaian Kinerja</span></a></li>
							...
							<?php } elseif ($row->id_jabatan == 3) { ?>
								...
								<li class="<?php echo $data_personal; ?>"><a href="<?php echo base_url() ?>c_hrd/v_pengajuan_dataPersonal"><i class="icon-list-unordered"></i> <span>Data Personal</span></a></li>
								<li class="<?php echo $pengalaman_kerja; ?>"><a href="<?php echo base_url() ?>c_hrd/v_pengajuan_pengalamanKerja"><i class="icon-list-unordered"></i> <span>Pengalaman Kerja</span></a></li>
								<li class="<?php echo $manajemencuti; ?>"><a href="<?php echo base_url() ?>c_hrd/v_pengajuan_cuti"><i class="icon-list-unordered"></i> <span>Manajemen Cuti</span></a></li>
								<li class="<?php echo $manajemenperjalanandinas; ?>"><a href="<?php echo base_url() ?>c_hrd/v_pengajuan_perjalanan_dinas"><i class="icon-list-unordered"></i> <span>Manajemen Perjalanan Dinas</span></a></li>

								<li class="<?php echo $jobprofile; ?>"><a href="<?php echo base_url() ?>c_hrd/tambah_job_profile"><i class="icon-list-unordered"></i> <span>Job Profile</span></a></li>

								<li class="<?php echo $jobprofile; ?>"><a href="<?php echo base_url() ?>c_user/komp_dev"><i class="icon-list-unordered"></i> <span>Pengembangan Kompetensi</span></a></li>

								<li class="<?php echo $jobprofile; ?>"><a href="<?php echo base_url() ?>c_user/v_hrd_performa"><i class="icon-list-unordered"></i> <span>Penilaian Kinerja</span></a></li>
							...
							<li class="<?php echo $data_personal; ?>"><a href="<?php echo base_url() ?>c_user/data_personal"><i class="icon-list-unordered"></i> <span>Data Personal</span></a></li>
							<li class="<?php echo $pengalaman_kerja; ?>"><a href="<?php echo base_url() ?>c_user/pengalaman_kerja/0"><i class="icon-list-unordered"></i> <span>Pengalaman Kerja</span></a></li>
							<li class="<?php echo $manajemencuti; ?>"><a href="<?php echo base_url() ?>c_user/manajemen_cuti"><i class="icon-list-unordered"></i> <span>Manajemen Cuti</span></a></li>
							<li class="<?php echo $manajemenperjalanandinas; ?>"><a href="<?php echo base_url() ?>c_user/manajemen_perjalanan_dinas"><i class="icon-list-unordered"></i> <span>Manajemen Perjalanan Dinas</span></a></li>
							<li class="<?php echo $jobprofile; ?>"><a href="<?php echo base_url('c_user/komdev_karyawan/'.$this->session->userdata('id')) ?>"><i class="icon-list-unordered"></i> <span>Pengembangan Kompetensi</span></a></li>

							<li class="<?php echo $jobprofile; ?>"><a href="<?php echo base_url() ?>c_user/performa_target"><i class="icon-list-unordered"></i> <span>Penilaian Kinerja</span></a></li>
