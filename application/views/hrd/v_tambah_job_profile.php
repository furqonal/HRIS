				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Tambah Job Profile</h5>
						...
						<div class="panel-body">
							<form class="form-horizontal" method="POST" action="<?= base_url()?>c_karyawan/tambahJobProfile">
								...
								<legend><b>	Identitas Jabatan</b></legend>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="atasan_langsung" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="bawahan_langsung" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="tujuan_jabatan" class="form-control">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="pendidikan_minimal" class="form-control">
										</div>
									</div>
									<div class="form-group">
